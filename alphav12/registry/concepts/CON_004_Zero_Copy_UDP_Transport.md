...
3.  **Manual Unrolling:** Maintain the 8-byte manual loop unrolling established in v10; the transport layer must not disrupt the mathematical instruction pipeline.
