...
class WorkerPool extends EventEmitter {
    constructor(numThreads = 0, scriptName = 'encoder_worker.js', sharedPool = null) {
        ...
        // v11 Optimization: Centralized Shared Memory
        if (!sharedPool) {
            throw new Error("[WorkerPool] A SharedBufferPool instance is required for v11 operation.");
        }
        ...
        for (let i = 0; i < numThreads; i++) {
            ...
            w.on('message', (msg) => {
                if (msg.type === 'PACKET') {
                    ...
                    // v11: Packet is in the Shared Pool. 
