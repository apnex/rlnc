# Feature: High-Performance RLNC v11 Engine (FEAT_SBOX_OPTIMIZATION)
...
### 2.2 Variant 2: v11 Vectorized (BigInt XOR)
...
### 2.3 Variant 3: v11 Fused (Normalization Skip)
...
### 2.4 Variant 4: v11 Direct (Pure Scalar Unrolled)
